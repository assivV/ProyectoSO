...
SELECT JUGADOR.NOMBRE, JUGADOR.ID FROM (JUGADOR) WHERE JUGADOR.PAIS='RUSIA';

SELECT DATOS.PUNTOS FROM (JUGADOR,DATOS) WHERE JUGADOR.NOMBRE='SERGIO' AND JUGADOR.ID=DATOS.ID_J;

SELECT PARTIDA.DURACION, PARTIDA.GANADOR FROM (JUGADOR,DATOS,PARTIDA) WHERE JUGADOR.NOMBRE='CARLES' AND JUGADOR.ID=DATOS.ID_J AND DATOS.ID_P=PARTIDA.ID;

SELECT PARTIDA.ID, PARTIDA.FECHA, PARTIDA.GANADOR, DATOS.PUNTOS FROM (DATOS,PARTIDA) WHERE DATOS.PUNTOS>200 AND DATOS.ID_P=PARTIDA.ID;
